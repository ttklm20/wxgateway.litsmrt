package iotwechat.xlink.cloud.protocal;
...
public class BlueLight {
	...
	public static enum CmdId {
		 ...
		 * 红灯
		 */
		RED_LIGHT_PUSH(0x3001),
		/**
		 * 橘色
		 */
		ORANGE_LIGHT_PUSH(0x3002),
		/**
		 * 黄色
		 */
		YELLOW_LIGHT_PUSH(0x3003),
		/**
		 * 蓝色
		 */
		BLUE_LIGHT_PUSH(0x3004),
		/**
		 * 紫色
		 */
		PURPLE_LIGHT_PUSH(0x3005),
		/**
		 * 白色
		 */
		WHITE_LIGHT_PUSH(0x3006);
